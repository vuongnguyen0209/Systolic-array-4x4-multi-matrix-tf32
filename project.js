...
module project (
    ...
    input  logic [1:0]  wr_j,

    input  logic [18:0] data_in,
    ...
    output logic [18:0] C00,
    output logic [18:0] C01,
    output logic [18:0] C02,
    output logic [18:0] C03,

    output logic [18:0] C10,
    output logic [18:0] C11,
    output logic [18:0] C12,
    output logic [18:0] C13,

    output logic [18:0] C20,
    output logic [18:0] C21,
    output logic [18:0] C22,
    output logic [18:0] C23,

    output logic [18:0] C30,
    output logic [18:0] C31,
    output logic [18:0] C32,
    output logic [18:0] C33
...
module stream_counter (
    ...
    always_ff @(posedge clk or posedge rst) begin
        ...
        if (rst) begin
            ...
            // =============================================
            // WAIT NEXT CLOCK AFTER rd_en
            // =============================================

            if (rd_en && !started) begin
...
module matrix_memory (
    ...
    always_comb begin
        ...
        if (rd_en && started && (cycle <= 3)) begin
